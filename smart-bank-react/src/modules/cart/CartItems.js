...
function CartItems() {
  ...
  const sendEmailOnConfirmation = (c) => {
    let emailData = {
      body: "Dear Customer,<br><br>Congratulations. You have successfully redeemed your points<br><br>Regards<br>SmartBank-SaturnTeam",
      title: "Order Confirmation",
      emailId: "rajatpandey7800@gmail.com",
    };
    axios
      .post(API_URL + "sendemail/", emailData)
      .then((response) => {
