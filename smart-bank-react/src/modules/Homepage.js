...
function Homepage() {
  ...
  const loggedInUser = {
    ccNumber: context.loggedInUser.ccNumber,
    ccName: context.loggedInUser.ccName,
    userName: context.loggedInUser.userName,
    userId: context.loggedInUser.userId,
    availableRedeemPoints: context.loggedInUser.availableRedeemPoints,
    totalRewardsGained: context.loggedInUser.totalRewardsGained,
  };
